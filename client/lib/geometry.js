...
GEN.Geometry.API.createParametricSurface = {
	...
	inputs : [{
		name : 'name',
		defaultVal : '"torus"',
		options : [['Torus', '"torus"'], ['Klein Surface', '"klein"'], ['Enneper Surface', '"enneper"'], ['Catenoid Surface', '"catenoid"'], ['Helicoidal Surface', '"helicoidal"']]
	}, {
		name : 'udiv',
		defaultVal : 20
	}, {
...
GEN.Geometry.API.meshComponents = {
	...
	inputs : [{
		name : 'componentType',
		options : [['Mesh Faces', '"faces"'], ['Mesh Edges', '"edges"'], ['Mesh Vertices', '"vertices"']]
	}, {
		name : 'mesh',
		type : GEN.types.Mesh
	}],
