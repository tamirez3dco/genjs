...
Blockly.hideChaff = function(opt_allowToolbox) {
  ...
  if (Blockly.Toolbox && Blockly.showToolbox && !opt_allowToolbox &&
...
Blockly.getMainWorkspaceMetrics = function() {
  ...
  if (Blockly.Toolbox && Blockly.showToolbox) {
  ...
  //var rightEdge = blockBox.x + blockBox.width;
  //var topEdge = blockBox.y;
  //var bottomEdge = blockBox.y + blockBox.height;
  var absoluteLeft = 0;
  if (Blockly.Toolbox && !Blockly.RTL && Blockly.showToolbox) {
...
Blockly.setMainWorkspaceMetrics = function(xyRatio) {
  ...
  var scale = "scale(" + Blockly.scale + "," + Blockly.scale + ")"; 
  Blockly.mainWorkspace.getCanvas().setAttribute('transform', translation + ' ' + scale);
...
Blockly.cssLoaded = function() {
  ...
  Blockly.Toolbox && Blockly.showToolbox && Blockly.Toolbox.redraw();
};
